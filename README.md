# DToS Screening - Cohort Manager prototype

Prototype of the Cohort Manager service, based on the <a href="http://nhsuk-prototype-kit.azurewebsites.net/docs">NHS.UK prototype kit site</a>.
